...
func TestListRecordsByVPC(t *testing.T) {
	// Create a mock client
	mockClient := &MockClient{}

	// Mock ListPrivateZones response
	mockZones := &privatezone.ListPrivateZonesOutput{
		Zones: []*privatezone.ZoneForListPrivateZonesOutput{&privatezone.ZoneForListPrivateZonesOutput{
	...
	mockClient.ListPrivateZonesFunc = func(ctx context.Context, input *privatezone.ListPrivateZonesInput) (*privatezone.ListPrivateZonesOutput, error) {
	...
	// Call the method
	endpoints, err := wrapper.ListRecordsByVPC(context.Background(), "vpc-123")
...
func TestGroupPrivateZoneRecords(t *testing.T) {
	...
	wrapper := &PrivateZoneWrapper{}
	grouped := wrapper.groupPrivateZoneRecords(records)
